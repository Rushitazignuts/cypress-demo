...
describe('Product List', () => {
  ...
  it('should update the cart total correctly', () => {
    ...
    // Introduce intentional flakiness
    const randomNumber = Math.floor(Math.random() * 10);
    if (randomNumber > 5) {
      cy.get('.cart h3').should('contain', 'Cart Total: 250'); // Expected behavior
    } else {
      cy.get('.cart h3').should('contain', 'Cart Total: 240'); // Incorrect behavior to introduce flakiness
    }
  });
